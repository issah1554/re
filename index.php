...
<body>
  ...
  <main id="view-panel">
    ...
    $requested_page = isset($_GET['page']) ? base64_decode($_GET['page']) : $default_page;
    $page = in_array($requested_page, $allowed_pages) ? $requested_page : $default_page;

    // Include the page (only if it exists in allowed list)
    include($page . '.php');
    ?>
